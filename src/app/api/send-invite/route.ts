        ...
        <div style="font-family:Arial,Helvetica,sans-serif;background:#f8fafc;padding:32px;color:#111827">
          <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:20px;padding:32px;border:1px solid #e5e7eb;box-shadow:0 10px 30px rgba(0,0,0,0.06)">
            ...
            <p style="font-size:15px;color:#6b7280;margin:0 0 20px">
              Te han invitado a la app para gestionar gastos y deudas entre colegas.
            </p>

            <h2 style="font-size:24px;margin:0 0 16px;color:#111827">
              Tienes una invitación pendiente
            </h2>

            <p style="font-size:15px;line-height:1.6;color:#374151;margin:0 0 22px">
              Entra en la app con este mismo correo y podrás aceptar la invitación,
              ver tus grupos y empezar a repartir gastos sin dramas.
            </p>

            <p style="font-size:14px;line-height:1.6;color:#b91c1c;margin:0 0 22px;font-weight:700">
              Importante: regístrate o inicia sesión con el mismo correo al que te llegó esta invitación.
            </p>

            <a
              href="${appUrl}"
              style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;padding:14px 20px;border-radius:12px;font-weight:700"
            >
              Abrir TeDebo
            </a>
